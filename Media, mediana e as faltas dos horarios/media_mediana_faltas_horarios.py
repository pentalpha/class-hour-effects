...
#Arquivo 1
with open('faltas_turno.csv',encoding="utf8") as csvfile:
    readCSV = csv.reader(csvfile, delimiter=',')
    for row in readCSV:
       Lista_N34.append(row[0])
       Lista_N12.append(row[1])
       Lista_T56.append(row[2])
       Lista_T34.append(row[3])
       Lista_T12.append(row[4])
       Lista_M56.append(row[5])
       Lista_M34.append(row[6])
       Lista_M12.append(row[7])
       Lista_faltas.append(row[8])
       Lista_medias.append(row[9])
       #print (row[9]) 
...
#Arquivo 2  
with open('aulas_turmas.csv', encoding="utf8") as csvfile:
    read = csv.reader(csvfile, delimiter = ',')
    for row in read:
        aux = 0
        if not Lista_id_turma:
            Lista_id_turma.append(row[0])
            Lista_aulas_N34.append(row[1])
            Lista_aulas_N12.append(row[2])
            Lista_aulas_T56.append(row[3])
            Lista_aulas_T34.append(row[4])
            Lista_aulas_T12.append(row[5])
            Lista_aulas_M56.append(row[6])
            Lista_aulas_M34.append(row[7])
            Lista_aulas_M12.append(row[8])
            Lista_aulas.append(row[11])
            Lista_medianas.append(row[12])
        else:
