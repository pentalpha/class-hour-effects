...
print("Total of " + str(original) + " in raw input files.")
print("Added " + str(len(rows)))
print("Dropped " + str(original - len(rows)))
...
def makeTurmasDf():
    ...
    print(str(len(finalDf)) + " after filtering for classes with lessons and students.")
